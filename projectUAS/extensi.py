...
def generate_array(n, max_value=177, seed=42):
    random.seed(seed)
...
max_value = 182 #value is from 250 - the last 3 digits of NIM
seed = 67
...
plt.plot(n_values, worst_case_times, label="Worst Case", marker="s", color="yellow")
plt.plot(n_values, average_case_times, label="Average Case", marker="o", color="green")
